# -*- coding: utf-8 -*-
"""
Created on Mon Nov 29 21:14:44 2021
...
print('Downloading the restaurant data...')
response = requests.get('https://data.cityofchicago.org/resource/4ijn-s7e5.json')

# Save retrieved data to a local file
print('Saving restaurant data to a file...')

outfile_path = f'restaurant_{dt.date.today()}.json'
...
outfile_path1 = f'restaurant_{dt.date.today()}.json'
...
blob_name = f'restaurant_{dt.date.today()}.json'
