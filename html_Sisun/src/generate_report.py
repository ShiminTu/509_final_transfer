...
def main():
    ...
    # Write the overview.
    write_overview(gro_mapdata_gdf, neigh_mapdata_gdf, neighborhood_df, nhood_df, max_crime, min_crime, overview_template, output_root)
...
def write_overview(gro_mapdata_gdf, neigh_mapdata_gdf, neighborhood_df, nhood_df, max_crime, min_crime, template, output_root):
...
def write_neighborhood(neighborhood, template, output_root,
    ...
    with open(output_root /  f'{neighborhood.neighborhood_name}.html', 'w') as local_file:
        local_file.write(output)
